<nav class="bg-[#1C315E] py-5 px-10">
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center gap-5">
      ...
      <a href="{{ route('register') }}" class="py-1.5 px-3 border-2 border-[#C0EEE4] rounded-lg text-[#C0EEE4] hover:bg-[#C0EEE4] hover:text-[#1C315E] transition duration-200">register</a>
      @endguest
      @if(Auth::check())
      <a href="{{ route('logout') }}" class="py-1.5 px-3 border-2 border-[#C0EEE4] rounded-lg text-[#C0EEE4] hover:bg-[#C0EEE4] hover:text-[#1C315E] transition duration-200">{{ __('logout') }}</a>
      @endif
    </div>
  </div>
</nav>